 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://pruebaWS/", wsdlLocation = "http://localhost:8080/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://pruebaWS/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication1/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://pruebaWS/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pruebaWS/", "NewWebServicePort"), NewWebService.class, features);
    }
