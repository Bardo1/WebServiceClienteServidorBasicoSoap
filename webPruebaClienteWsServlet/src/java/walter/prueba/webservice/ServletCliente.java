 ...
 */
package walter.prueba.webservice;
...
import pruebaws.NewWebService_Service;
...
public class ServletCliente extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/WebApplication1/NewWebService.wsdl")
    ...
    private int add(int valor1, int valor2) {
